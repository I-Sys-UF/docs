...
関数を使うとき（呼ぶ．などといいます），データを渡して呼ぶときがありますが，そのとき渡す値は「引数」（ひきすう）と呼ばれます．関数の機能に応じて，任意の個数渡すことができます  
また，関数からデータが戻ってくることがあります．何かしらの計算をする関数を思い浮かべるとわかりやすいかもしれません．戻ってくるデータのことを「返り値」・「戻り値」などと呼びます  
これら引数や戻り値は一般に変数なので，「型」があります．型とは，簡単に言えばそのデータがどのような種類のものかを表すもので，文字，整数，小数などがあります
